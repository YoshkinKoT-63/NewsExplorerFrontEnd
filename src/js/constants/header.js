...
const NAV_SAVED_ARTICLES = document.querySelector('#saved-articles-template');

export { HEADER_CONTAINER, NAV_AUTH_TEMPLATE, NAV_UNAUTH_TEMPLATE, NAV_SAVED_ARTICLES };
